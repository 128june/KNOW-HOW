...
for asset in ('style.css', 'shell.css', 'config.js', 'app.js', 'demo-example.js', 'source-records.js', 'organization-kb.js', 'demo.js', 'general-knowledge.js', 'data-knowledge-bridge.js','data-explorer.js','data-review-ui.js','data-handoff-ui.js','data-platform.css','data-platform.js', 'platform-shell.js'):
