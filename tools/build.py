...
out.mkdir()
for name in ('index.html','style.css','app.js','demo-example.js','source-records.js','organization-kb.js','demo.js','general-knowledge.js','data-knowledge-bridge.js','data-explorer.js','data-platform.js','platform-shell.js'): shutil.copyfile(root/'src'/name,out/name)
...
for asset in ('style.css', 'config.js', 'app.js', 'demo-example.js', 'source-records.js', 'organization-kb.js', 'demo.js', 'general-knowledge.js', 'data-knowledge-bridge.js','data-explorer.js','data-platform.js', 'platform-shell.js'):
