...
out.mkdir()
for name in ('index.html','style.css','shell.css','app.js','demo-example.js','source-records.js','organization-kb.js','demo.js','general-knowledge.js','data-knowledge-bridge.js','data-explorer.js','data-review-ui.js','data-handoff-ui.js','data-platform.css','data-lineage-ui.js','data-platform.js','support-workspace.js','support-workspace.css','support-kb-pending.js','support-kb-pending.css','kb-catalog.js','kb-lineage.js','kb-lineage.css','home-knowledge.js','home-knowledge.css','platform-shell.js'): shutil.copyfile(root/'src'/name,out/name)
...
for asset in ('style.css', 'shell.css', 'config.js', 'app.js', 'demo-example.js', 'source-records.js', 'organization-kb.js', 'demo.js', 'general-knowledge.js', 'data-knowledge-bridge.js','data-explorer.js','data-review-ui.js','data-handoff-ui.js','data-platform.css','data-lineage-ui.js','data-platform.js','support-workspace.js','support-workspace.css','support-kb-pending.js','support-kb-pending.css','kb-catalog.js','kb-lineage.js','kb-lineage.css','home-knowledge.js','home-knowledge.css', 'platform-shell.js'):
