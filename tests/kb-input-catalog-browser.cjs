...
async function main(){
 ...
 try{
  await page.goto(origin);await page.addStyleTag({url:origin+'/src/style.css'});await page.addStyleTag({url:origin+'/src/kb-lineage.css'});
